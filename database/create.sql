...
CREATE TABLE IF NOT EXISTS `tb_desempenho` (
	...
	`vl_precision` decimal(10,0) NOT NULL,
	`vl_recall` decimal(10,0) NOT NULL,
	`vl_f1_score` decimal(10,0) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_execucao` (
	...
	`vl_accuracy` decimal(10,0) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_hiperparametro` (
	...
	`vl_parametro` decimal(10,0) NOT NULL,
